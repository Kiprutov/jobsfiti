      ...
      <div className="w-full px-3 pr-5 md:pr-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            {/* Auth Section - Hidden on main pages as requested */}
            {/* {!loading && user && (
          ...
          <div className="px-3 py-4 space-y-2">
            ...
            <div>
              ...
              >
                ...
                <ChevronDown
                  size={16}
                  className={`transition-transform ${isJobsOpen ? "rotate-180" : ""
                    }`}
                />
              </button>
              {isJobsOpen && (
            ...
            <div>
              ...
              >
                ...
                <ChevronDown
                  size={16}
                  className={`transition-transform ${isPagesOpen ? "rotate-180" : ""
                    }`}
                />
              </button>
              {isPagesOpen && (
